...
class DeleteProductoCompra(private val carritoRepository: CarritoRepository) {
    suspend operator fun invoke(producto: Producto) = carritoRepository.deleteProductoCompra(producto)
}